 ...
 */
package ifpb.praticas.projeto.john.web;

import ifpb.praticas.projeto.john.shared.Calculadora;
import ifpb.praticas.projeto.john.shared.ServiceLocator;
...
public class CalculadoraServlet extends HttpServlet {
    private final Calculadora calculadora = new ServiceLocator().lookup();
    /**
